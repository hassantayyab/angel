...
const Hero = ({ data }) => (
  <div className='relative bg-black h-home-hero'>
    ...
    <div className='relative h-full px-6 py-40 sm:px-16'>
      <div className='flex flex-col items-center justify-center w-full h-full px-8 py-12 text-center text-white uppercase br-frame sm:text-left sm:items-start sm:w-3/5 lg:w-1/2 top-20 border-yellow'>
